...
def build_queries_from_text(
    ...
    Args:
        ...
        top_k_for_query: Number of keywords to use in query
        quote_sentence: Optional quote sentence
        article_date: Optional article date (YYYY-MM-DD)
        rollcall_mode: Use rollcall.com-oriented query construction
        device: Device index (0 for CPU, >0 for GPU)
        debug: Enable debug output
        
    Returns:
        Dictionary with entities, keywords, entities_by_type, and queries
    """
