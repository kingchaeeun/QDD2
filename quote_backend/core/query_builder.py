...
# Import name resolution - use compatibility wrapper
try:
    from qdd2.name_resolution import resolve_person_name_en
except ImportError:
    # Fallback: simple translation-based resolution
    def resolve_person_name_en(name_ko: str) -> str:
        """
        Resolve Korean person name to English.
        Fallback implementation using translation.
        """
        try:
